...
Model identifiers are the provider's native string (e.g., `"gpt-5.4"`, `"claude-opus-4-6"`, `"gemini-3-flash-preview"`). The library does not invent its own model namespace. This avoids the maintenance burden of mapping tables and ensures new models work immediately without library updates. If a model string could be ambiguous (multiple providers support it), the `provider` field on the request disambiguates.
...
MODELS = [
    ...
    ModelInfo(id="gpt-5.4",                 provider="openai",    display_name="GPT-5.3 Codex",     context_window=1047576, supports_tools=true, supports_vision=true, supports_reasoning=true),
    ModelInfo(id="gpt-5.4-spark",           provider="openai",    display_name="GPT-5.3 Codex Spark", context_window=128000,  supports_tools=true, supports_vision=false, supports_reasoning=true),
    ModelInfo(id="gpt-5.4",                 provider="openai",    display_name="GPT-5.3 Codex",     context_window=1047576, supports_tools=true, supports_vision=true, supports_reasoning=true),
    ModelInfo(id="gpt-5.4",                 provider="openai",    display_name="GPT-5.3 Codex",     context_window=1047576, supports_tools=true, supports_vision=true, supports_reasoning=true),
...
CATCH ProviderError:
    result = generate(model = "gpt-5.4", provider = "openai", prompt = "...")
```
